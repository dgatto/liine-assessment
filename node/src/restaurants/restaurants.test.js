...
test('returns expected list when datetime goes overnight', async () => {
  const data = [
    {
      'Restaurant Name': 'Garland',
      Hours: 'Mon-Wed 5 pm - 12:30 am',
    },
  ];

  expect(await getByDate(new Date('2024-11-05T11:30:00'), data)).toStrictEqual([
    'Garland',
  ]);
});
